...
def migrate_v06_review_attempts(connection: sqlite3.Connection) -> None:
    """添加复刷记录表"""
    connection.execute("""
        CREATE TABLE IF NOT EXISTS review_attempts (
            ...
            hint_content TEXT NOT NULL DEFAULT '',
    ...
    """)
    connection.execute("CREATE INDEX IF NOT EXISTS idx_review_attempts_created_at ON review_attempts (created_at)")
    connection.execute("CREATE INDEX IF NOT EXISTS idx_review_attempts_subject ON review_attempts (subject)")
